...
values('Bucuresti', 2, 'Lalelelor', '123', 'Admin first', 'password', 'lastName', 'adminUsername'),
      ('Timisoara', 21, 'Aleea Libertatii', '22', 'Client first', 'password2', 'clientLastName', 'clientUsername'),
      ('Timisoara', 21, 'Aleea Libertatii', '22', 'Expeditor first', 'password2', 'expeditorLastName', 'expeditorUsername');
